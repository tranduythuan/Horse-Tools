...
function horsetools_index_pages() {
	return array(
		...
		'horsetools-security-options'  => 'horsetools_security_page',
		'horsetools-speed-options'     => 'horsetools_speed_page',
		'horsetools-content-options'   => 'horsetools_content_page',
		'horsetools-display-options'   => 'horsetools_display_page',
		'horsetools-customers-options' => 'horsetools_customers_page',
