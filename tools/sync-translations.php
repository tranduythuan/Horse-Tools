...
$vi = array(
    ...
    'Posts with fewer questions than this get no schema. Two or more is the safer choice.' => 'Bài ít câu hỏi hơn mức này sẽ không được gắn schema. Từ 2 trở lên là an toàn hơn.',
    'Trim answers to this many characters' => 'Cắt câu trả lời còn bấy nhiêu ký tự',
    'Only the schema is trimmed; the post itself is never touched.' => 'Chỉ cắt trong schema, bài viết không hề bị đụng tới.',
