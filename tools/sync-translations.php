...
$vi = array(
	...
	// Chẩn đoán thư gửi đi + bằng chứng thư tới (1.3.34).
	'Does mail from this site actually arrive?' => 'Thư site này gửi đi có tới nơi thật không?',
	'WordPress reports a message as sent once it has handed it over. That says nothing about whether it arrived, and on a great many sites it does not — the domain names which servers may send for it, the web server is not one of them, and every notification the site sends is treated as forged. Nothing in WordPress mentions this. Below is what your domain’s own records say, read live.' => 'WordPress báo "đã gửi" ngay khi nó giao thư đi. Câu đó không nói gì về việc thư có tới hay không, và trên rất nhiều site thì không tới — tên miền khai rõ những máy chủ nào được phép gửi thay nó, web server lại không nằm trong số đó, nên mọi thông báo site gửi ra đều bị coi là giả mạo. WordPress không hề nhắc chuyện này. Bên dưới là những gì bản ghi của chính tên miền anh nói, đọc trực tiếp.',
	'Read the records again' => 'Đọc lại bản ghi',
	'Answers are held for half a day; press this after changing anything in DNS.' => 'Kết quả được giữ nửa ngày; đổi gì trong DNS thì bấm nút này.',
	'This host does not let the plugin read DNS, so none of the checks below can be made. That is not the same as everything being in order.' => 'Hosting này không cho plugin đọc DNS, nên không kiểm được gì bên dưới. Cái đó khác với "mọi thứ đều ổn".',
	'Mail this site sends as %s is treated as forged. Your domain publishes a list of servers allowed to send for it, that list ends in “reject everything else”, and this web server is not on it.' => 'Thư site gửi danh nghĩa %s đang bị coi là giả mạo. Tên miền của anh có công bố danh sách máy chủ được phép gửi thay nó, danh sách đó kết thúc bằng "còn lại thì chặn hết", và web server này không nằm trong đó.',
	'This web server is not on your domain’s list of allowed senders. The list says “treat anything else as suspicious” rather than “reject it”, so mail as %s will usually arrive in the spam folder.' => 'Web server này không nằm trong danh sách được phép gửi của tên miền. Danh sách ghi "còn lại thì coi là đáng ngờ" chứ không phải "chặn", nên thư danh nghĩa %s thường rơi vào thư mục spam.',
	'This web server is on your domain’s list of allowed senders.' => 'Web server này nằm trong danh sách được phép gửi của tên miền.',
	'Your domain has a list of allowed senders, but it could not be worked out from here whether this server is on it.' => 'Tên miền có danh sách máy chủ được phép gửi, nhưng từ đây không xác định được server này có nằm trong đó hay không.',
	'Your domain says which servers may send mail for it, and this site is sending straight from the web server. Whether that server is on the list could not be determined here.' => 'Tên miền có khai những máy chủ nào được gửi thay nó, mà site đang gửi thẳng từ web server. Từ đây không xác định được server đó có nằm trong danh sách không.',
	'Send through an email service instead — then the question does not arise.' => 'Gửi qua một dịch vụ email thì khỏi phải hỏi câu đó nữa.',
	'Send through an email service that is on the list, or add this server to it.' => 'Gửi qua một dịch vụ email có trong danh sách, hoặc thêm server này vào danh sách.',
	'Send through an email service that is on the list.' => 'Gửi qua một dịch vụ email có trong danh sách.',
	'Your domain does not say which servers are allowed to send mail for it. Anyone can send mail claiming to be you, and mail you really did send has nothing to vouch for it — Gmail and Yahoo both treat that as a reason for suspicion.' => 'Tên miền của anh không khai máy chủ nào được phép gửi thư thay nó. Ai cũng có thể gửi thư tự xưng là anh, còn thư anh gửi thật thì chẳng có gì bảo chứng — Gmail lẫn Yahoo đều coi đó là lý do để nghi ngờ.',
	'Add an SPF record. Whichever email service you choose below will give you the exact line.' => 'Thêm một bản ghi SPF. Dịch vụ email nào anh chọn bên dưới cũng sẽ đưa cho anh đúng dòng cần dán.',
	'Your domain has no DMARC record, so you are never told when somebody sends mail pretending to be you, and receivers have no instruction about what to do with it.' => 'Tên miền không có bản ghi DMARC, nên có ai giả danh anh gửi thư thì anh không bao giờ biết, và bên nhận cũng không được chỉ dẫn phải làm gì với thư đó.',
	'A safe first one collects reports and changes nothing: a TXT record at _dmarc.%1$s with the value %2$s' => 'Bản đầu tiên an toàn nhất chỉ thu báo cáo chứ không đổi gì: một bản ghi TXT tại _dmarc.%1$s với giá trị %2$s',
	'Nothing accepts mail for %s, so any address at your own domain cannot receive replies. If you have stopped paying for a mailbox provider, its records may still be pointing there.' => 'Không có gì nhận thư cho %s cả, nên mọi địa chỉ ở tên miền của anh đều không nhận được thư trả lời. Nếu anh đã ngưng trả tiền cho một nhà cung cấp hộp thư, bản ghi có thể vẫn còn trỏ về đó.',
	'Either set up a mailbox for the domain, or make sure the address you send notifications to is one you actually read.' => 'Hoặc dựng một hộp thư cho tên miền, hoặc bảo đảm địa chỉ nhận thông báo là địa chỉ anh thật sự có đọc.',
	'Your domain receives mail through %s. Sending through the same service is the setting most likely to work, because it is already on your domain’s list of allowed senders.' => 'Tên miền của anh nhận thư qua %s. Gửi qua chính dịch vụ đó là cấu hình dễ chạy nhất, vì nó vốn đã nằm trong danh sách được phép gửi của tên miền.',
	'Prove it' => 'Chứng minh đi',
	'Nothing running on this server can find out whether a message arrived. You can. Send one, look, and say what you found — the answer is kept with the date, so this screen can afterwards report something that was seen rather than something that was switched on.' => 'Không thứ gì chạy trên server này biết được một lá thư có tới hay không. Anh thì biết. Gửi một cái, mở ra xem, rồi nói lại anh thấy gì — câu trả lời được lưu kèm ngày, để từ đó màn hình này báo cái đã được nhìn thấy chứ không phải cái đã được bật.',
	'an address you can open right now' => 'một địa chỉ anh mở ra xem được ngay bây giờ',
	'Send a test' => 'Gửi thử',
	'Sent to %s. Now go and look — and do not close this page, because the useful part is what you find.' => 'Đã gửi tới %s. Giờ mở ra xem — và đừng đóng trang này, vì phần có ích chính là thứ anh tìm thấy.',
	'Where did it turn up?' => 'Nó nằm ở đâu?',
	'In the inbox' => 'Trong hộp thư chính',
	'In the spam folder' => 'Trong thư mục spam',
	'Nowhere — it never came' => 'Không thấy đâu — không tới',
	'Give it a minute before answering. “In the spam folder” is a useful answer, not a failure to report.' => 'Chờ một phút rồi hãy trả lời. "Trong thư mục spam" là một câu trả lời có ích, không phải chuyện đáng ngại phải giấu.',
	'Where this stands:' => 'Tình trạng hiện tại:',
	'Mail from this site is known to arrive' => 'Thư từ site này đã biết chắc là tới nơi',
	'Confirmed %s ago' => 'Đã xác nhận %s trước',
	'Your last test landed in the spam folder' => 'Lần thử gần nhất rơi vào thư mục spam',
	'Your last test never arrived' => 'Lần thử gần nhất không tới nơi',
	'A test was sent but you have not said whether it arrived' => 'Đã gửi thử nhưng anh chưa nói nó có tới hay không',
	'Nobody has ever checked that mail from this site arrives' => 'Chưa ai từng kiểm xem thư từ site này có tới nơi không',
	'Your email settings changed after the last test, so what is running now has not been tried' => 'Cài đặt email đã đổi sau lần thử gần nhất, nên cái đang chạy thì chưa được thử',
	'That is not an email address.' => 'Đó không phải một địa chỉ email.',
	'WordPress could not hand the message to the mail server at all, so it never left the site.' => 'WordPress không giao được thư cho máy chủ mail, nên nó chưa hề rời khỏi site.',
	'Test message from %s' => 'Thư thử từ %s',
	'This is a test message from %s.' => 'Đây là thư thử từ %s.',
