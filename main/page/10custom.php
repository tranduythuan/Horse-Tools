...
<div id="play10" class="ht-card toggle-div">
  <h3><i class="fa-regular fa-screwdriver-wrench"></i> <?php _e('Change login link', 'horse-tools') ?></h3>
	...
	<p class="ht-note"><i class="fa-regular fa-lightbulb-on"></i> <?php _e('Enable this feature and enter the login link suffix', 'horse-tools'); ?><br>
  ...
  <h3><i class="fa-regular fa-swatchbook"></i> <?php _e('Custom WordPress login page', 'horse-tools') ?></h3>
	...
	<p class="ht-note"><i class="fa-regular fa-lightbulb-on"></i> <?php _e('The standard size for the logo is 280x80 PX', 'horse-tools'); ?></p>
	...
	<p class="ht-note"><i class="fa-regular fa-lightbulb-on"></i> <?php _e('None: default not selected, Auto: background image automatically changes each time the page is loaded, Color: change the color you want, Upload: upload the background image you want', 'horse-tools'); ?></p>
  ...
  <h3><i class="fa-brands fa-wordpress"></i> <?php _e('Change WordPress logo in the Admin bar', 'horse-tools') ?></h3>
	...
	<p class="ht-note"><i class="fa-regular fa-lightbulb-on"></i> <?php _e('The changing image is square, with the standard size being 100x100 pixels', 'horse-tools'); ?></p>
  ...
  <h3><i class="fa-regular fa-window"></i> <?php _e('Customize dashboard widgets', 'horse-tools') ?></h3>
