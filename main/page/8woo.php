...
<div id="play8" class="ht-card toggle-div">
  <h3><i class="fa-regular fa-text-size"></i> <?php _e('Modify content', 'horse-tools') ?></h3>
	<p>
	...
	<p class="ht-note"><i class="fa-regular fa-lightbulb-on"></i> <?php _e('Modify some information on Woocommerce that you want', 'horse-tools'); ?></p>
  <h3><i class="fa-regular fa-text-size"></i> <?php _e('Customize Currency Unit', 'horse-tools') ?></h3>
	<p>
